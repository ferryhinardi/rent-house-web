    ...
    <div>
      ...
      <ContainerDesktop style={styles.container}>
        ...
        <Text ink="dark" variant="large">
          ...
          <br />
          <Text ink="dark">
            Our strategy identifies value-add opportunities by capitalizing on under-utilized space to increase the cap
            rate upon purchase.
          </Text>
          <br />
          <br />
        ...
        <Text ink="dark" variant="large">
          ...
          <br />
          <br />
          <Text ink="dark">Floor plans, building massing, financial models, offering memorandums, etc</Text>
          <br />
          <br />
          Ryna&apos;s evaluation
          <br />
          <br />
          <Text ink="dark">Ryna will provide a detailed pro-forma and property analysis</Text>
          <br />
          <br />
          Sign agreement & lease up
          <br />
          <br />
          <Text ink="dark">Ryna will also provide on-going tenant relationship management.</Text>
          <br />
          <br />
        </Text>
        ...
        <Text ink="dark" variant="large">
          ...
          <br />
          <br />
          <Text ink="dark">Ryna manages and enhances tenant relationship and engagement.</Text>
          <br />
          <br />
