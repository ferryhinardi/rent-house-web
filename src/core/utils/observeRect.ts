...
let rectChanged = (a: DOMRect = {} as DOMRect, b: DOMRect = {} as DOMRect) => props.some(prop => a[prop] !== b[prop]);
...
export default function observeRect(node: HTMLElement, cb: Function) {
  return {
    observe() {
